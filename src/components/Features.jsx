...
const Features = () => {
  ...
  return (
    <section className="h-full common-paddding bg-zinc relative overflow-hidden">
        <div className="screen-max-width">
            <div className="mb-12 w-full">
                <h1 id="features_title"
                className="section-heading ms-4">Explore the full story.</h1>
            </div>
        </div>
        ...
        <div className="flex flex-col justify-center items-center overflow-hidden">
            ...
            <div className="flex flex-col w-full relative h-full">
                ...
                <div className="feature-text-container h-[30vh]">
                        <div className="flex-1 flex-center">
                            <p className="feature-text g_text">
                                iPhone 15 Pro is {' '}
                                <span className="text-white">
                                the first IPhone to feature an aerspace-grade titanium design
                                </span>,
